...
The three assumptions in a t-test is that the data set is normal, sample size 
...
Result3: The result description
...
total_SCFAs = sum(Butyrate_mmol_kg + Propionate_mmol_kg)
```
